...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppUpdateUpdateComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _bottom_sheet_data_bottom_sheet_data_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../bottom-sheet-data/bottom-sheet-data.component */
    "./src/app/bottom-sheet-data/bottom-sheet-data.component.ts");
    /* harmony import */
    ...
    function () {
      ...
      _createClass(UpdateComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.service.getUpdateRequired$().subscribe(function (result) {
            _this20.isUpdateRequired = result;
            _this20.isCheckingUpdateRequired = false;
          }, function (error) {
            console.log(error);
          });
          this.service.getMotd$().subscribe(function (result) {
            _this20.motd = result;
          }, function (error) {
            console.log(error);
          });
        ...
        value: function doUpdate() {
          ...
          this.service.doUpdate$().subscribe(function (result) {
            ...
            _this21.bottomSheet.open(_bottom_sheet_data_bottom_sheet_data_component__WEBPACK_IMPORTED_MODULE_1__["BottomSheetDataComponent"], {
              data: {
                message: msg,
                progress: true
              }
    ...
    UpdateComponent.ɵfac = function UpdateComponent_Factory(t) {
      return new (t || UpdateComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_3__["MatBottomSheet"]));
    };
    ...
    UpdateComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_5__["MatProgressBar"]],
