...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAudioSetupAudioSetupComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AudioSetupComponent_form_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AudioSetupComponent_form_3_Template_button_click_46_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);
  ...
  /***/
  function srcAppModelsRegistrationTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Registration = function Registration(jsonData) {
  ...
  function srcAppNetworkNetworkComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function NetworkComponent_form_3_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        var _r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](41);
    ...
    function () {
      ...
      _createClass(NetworkComponent, [{
        ...
        value: function onSubmit() {
          ...
          if (this.theForm.valid) {
            this.saving = true;
            this.service.networkSave$(this.getFormValues()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err, caught) {
              ...
              if (result.success) {
                if (result.data.ip !== window.location.hostname) {
                  var msg = "We're updating the ip address to '".concat(result.data.ip, "'. We'll redirect you there shortly.");
  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _models_registration__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../models/registration */
    "./src/app/models/registration.ts");
    /* harmony import */


    var _service_result__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./service-result */
    ...
    function () {
      ...
      _createClass(ApiService, [{
        ...
        value: function update$() {
          ...
          return this.http.get('/api/update').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this8.log('GET: /api/update', result);
        ...
        value: function network$() {
          ...
          return this.http.get('/api/network/config').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this9.log('GET: /api/network/config', result);
        ...
        value: function networkSave$(data) {
          ...
          return this.http.post('/api/network/config', data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this10.log('PUT: /api/network/config', result); // let data = new Network(result.data);
        ...
        value: function registration$() {
          var reg = new _models_registration__WEBPACK_IMPORTED_MODULE_4__["Registration"]({
            first_use: false,
          ...
          var rslt = new _service_result__WEBPACK_IMPORTED_MODULE_5__["ServiceResult"](reg);
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(rslt); // this.http.get<ServiceResult<Registration>>('/api/registration')
          //   .pipe(
          //     map(result => {
        ...
        value: function registrationSave$(data) {
          ...
          return this.http.put('/api/registration', data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this11.log('PUT: /api/registration', result);

            var data = new _models_registration__WEBPACK_IMPORTED_MODULE_4__["Registration"](result.data);
            var msg = 'You\'ve successfully updated your registration.';
            var success = true;
        ...
        value: function getAudioConfig$() {
          ...
          return this.http.get('/api/audio/config').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this12.log('GET: /api/audio/config', result);
        ...
        value: function putAudioConfig$(data) {
          ...
          return this.http.post('/api/audio/config', data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this13.log('POST: /api/audio/config', result);
        ...
        value: function ouput1$() {
          ...
          var result = new _service_result__WEBPACK_IMPORTED_MODULE_5__["ServiceResult"]();
          result.data = ret;
        ...
        value: function oscOCXO$() {
          ...
          return this.http.get('/api/ocxo').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this14.log('GET: /api/ocxo', result);
        ...
        value: function oscDFXO$() {
          ...
          return this.http.get('/api/dfxo').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this15.log('GET: /api/dfxo', result);
        ...
        */
        ...
        value: function handleError() {
          ...
          return function (error) {
            ...
            _this16.log("".concat(operation, " failed: ").concat(error.message), result); // Let the app keep running by returning an empty result.
    ...
    ApiService.ɵfac = function ApiService_Factory(t) {
      return new (t || ApiService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClient"]));
    };
