        ...
        value: function onSubmit() {
          ...
          if (this.theForm.valid) {
            ...
            this.service.registrationSave$(this.getFormValues()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err, caught) {
              _forms_form_validation__WEBPACK_IMPORTED_MODULE_6__["FormValidation"].parseSubmitErrors(err, _this7.theForm);
              ...
              if (savedData.success) {
                ...
                _this7.bottomSheet.open(_bottom_sheet_data_bottom_sheet_data_component__WEBPACK_IMPORTED_MODULE_5__["BottomSheetDataComponent"], {
                  data: {
