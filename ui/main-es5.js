...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAudioSetupAudioSetupComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AudioSetupComponent_form_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AudioSetupComponent_form_3_Template_button_click_61_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);
  ...
  function srcAppHelpSupportSupportComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_bottom_sheet_data_bottom_sheet_data_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/bottom-sheet-data/bottom-sheet-data.component */
    "./src/app/bottom-sheet-data/bottom-sheet-data.component.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function SupportComponent(service, bottomSheet) {
      ...
      _createClass(SupportComponent, [{
        key: "enableRemoteSupport",
        value: function enableRemoteSupport() {
          var _this3 = this;

          this.buttonDisabled = true;
          this.service.doRemote$().subscribe(function (result) {
            var msg = "";
            ...
            _this3.bottomSheet.open(src_app_bottom_sheet_data_bottom_sheet_data_component__WEBPACK_IMPORTED_MODULE_2__["BottomSheetDataComponent"], {
              data: {
                message: msg,
                progress: result
              }
        ...
        key: "disableRemoteSupport",
        value: function disableRemoteSupport() {
          var _this4 = this;

          this.service.killRemote$().subscribe(function (result) {
            _this4.buttonDisabled = false;
            var msg = "We turned off remote support.";

            _this4.bottomSheet.open(src_app_bottom_sheet_data_bottom_sheet_data_component__WEBPACK_IMPORTED_MODULE_2__["BottomSheetDataComponent"], {
              data: {
                message: msg,
                progress: result
              }
        ...
        value: function ngOnInit() {
          ...
          var sub = this.service.getRemotePID$().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (data) {
            _this5.buttonDisabled = !!data;
          })).subscribe();
          this.subs.push(sub);
        }
      }, {
    ...
    SupportComponent.ɵfac = function SupportComponent_Factory(t) {
      return new (t || SupportComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_4__["MatBottomSheet"]));
    };
    ...
    SupportComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 27,
      vars: 2,
      consts: [["id", "section-network", 1, "container", "flex-fill"], ["href", "tel:919.494.1800"], ["href", "mailto:alwayslistening@musicapristina.com"], ["role", "group", "aria-label", "Remote Support", 1, "btn-group"], ["type", "button", 1, "btn", "btn-primary", 3, "disabled", "click"]],
      template: function SupportComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SupportComponent_Template_button_click_21_listener($event) {
            return ctx.enableRemoteSupport();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SupportComponent_Template_button_click_23_listener($event) {
            return ctx.disableRemoteSupport();
          });
            ...
            this.service.networkSave$(this.model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err, caught) {
              ...
              if (result.success) {
                ...
                /* DHCP */
                    ...
                    _this7.bottomSheet.open(_bottom_sheet_data_bottom_sheet_data_component__WEBPACK_IMPORTED_MODULE_4__["BottomSheetDataComponent"], {
                      data: {
                        message: msg,
                        progress: true
                      }
          ...
          if (this.theForm) {
            ...
            if (model) {
              ...
              this.type.valueChanges.subscribe(function (result) {
                _this8.setControlState(_this8.type.value === 1
                /* Static */
                );
              });
            } else {
  ...
  function srcAppRegistrationRegistrationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _bottom_sheet_data_bottom_sheet_data_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../bottom-sheet-data/bottom-sheet-data.component */
    "./src/app/bottom-sheet-data/bottom-sheet-data.component.ts");
    /* harmony import */


    var _forms_form_validation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../forms/form-validation */
    "./src/app/forms/form-validation.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function RegistrationComponent(fb, service, bottomSheet, data) {
        ...
        value: function onSubmit() {
          ...
          if (this.theForm.valid) {
            ...
            this.service.registrationSave$(this.getFormValues()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err, caught) {
              _forms_form_validation__WEBPACK_IMPORTED_MODULE_6__["FormValidation"].parseSubmitErrors(err, _this10.theForm);

              _this10.saving = false; // return Observable.empty();
              ...
              if (savedData.success) {
                ...
                _this10.bottomSheet.open(_bottom_sheet_data_bottom_sheet_data_component__WEBPACK_IMPORTED_MODULE_5__["BottomSheetDataComponent"], {
                  data: {
      ...
      _createClass(ApiService, [{
        ...
        value: function getMotd$() {
          ...
          return this.http.get("/api/system/motd", {
            ...
            _this11.log("GET: /api/system/motd", result);
        ...
        value: function getUpdateRequired$() {
          ...
          return this.http.get("/api/system/update").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this12.log("GET: /api/system/update", result);
        ...
        value: function doUpdate$() {
          ...
          return this.http.post("/api/system/update", null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this13.log("POST: /api/system/update", result);
        ...
        key: "doRemote$",
        value: function doRemote$() {
          var _this14 = this;

          return this.http.post("/api/system/remote", null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this14.log("POST: /api/system/remote", result);
        ...
        key: "getRemotePID$",
        value: function getRemotePID$() {
          var _this15 = this;

          return this.http.get("/api/system/remote").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this15.log("GET: /api/system/remote", result);
        ...
        key: "killRemote$",
        value: function killRemote$() {
          var _this16 = this;

          return this.http.post("/api/system/remote/kill", null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this16.log("POST: /api/system/remote/kill", result);
        ...
        value: function network$() {
          ...
          return this.http.get("/api/network/config").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this17.log("GET: /api/network/config", result);
        ...
        value: function networkSave$(data) {
          ...
          return this.http.post("/api/network/config", data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this18.log("POST: /api/network/config", result); // let data = new Network(result.data);
        ...
        value: function registration$() {
          ...
          return this.http.get("/api/system/registration").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this19.log("GET: /api/system/registration", result);
        ...
        value: function registrationSave$(data) {
          ...
          return this.http.post("/api/system/registration", data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this20.log("POST: /api/system/registration", result); // const data = new Registration(result.data);
        ...
        value: function getAudioConfig$() {
          ...
          return this.http.get("/api/audio/config").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this21.log("GET: /api/audio/config", result);
        ...
        value: function putAudioConfig$(data) {
          ...
          return this.http.post("/api/audio/config", data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this22.log("POST: /api/audio/config", result);
        ...
        value: function oscOCXO$() {
          ...
          return this.http.get("/api/ocxo").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this23.log("GET: /api/ocxo", result);
        ...
        value: function oscDFXO$() {
          ...
          return this.http.get("/api/dfxo").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
            _this24.log("GET: /api/dfxo", result);
        ...
        value: function handleError() {
          ...
          return function (error) {
            ...
            _this25.log("".concat(operation, " failed: ").concat(error.message), result); // Let the app keep running by returning an empty result.
  ...
  function srcAppUpdateUpdateComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function UpdateComponent(service, bottomSheet) {
        ...
        this.service = service;
        this.bottomSheet = bottomSheet; // public isUpdateRequired = false;
      ...
      _createClass(UpdateComponent, [{
        ...
        value: function doUpdate() {
          ...
          this.service.doUpdate$().subscribe(function (result) {
            ...
            _this27.bottomSheet.open(_bottom_sheet_data_bottom_sheet_data_component__WEBPACK_IMPORTED_MODULE_2__["BottomSheetDataComponent"], {
              data: {
                message: msg,
                progress: result
              }
    ...
    UpdateComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 2,
      consts: [["id", "section-network", 1, "container", "flex-fill"], ["type", "button", 1, "btn", "btn-primary", 3, "disabled", "click"], [1, "mt-5"]],
      template: function UpdateComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UpdateComponent_Template_button_click_6_listener($event) {
            return ctx.doUpdate();
          });
